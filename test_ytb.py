...
import numpy as np
from datasets.ytb_val import YTBVAL
...
def main(args):
    ...
    TestDataset = YTBVAL(args.filepath)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filepath', help='Data path for Davis', default='/dataset2/zzh/valid')
    parser.add_argument('--savepath', type=str, default='/home/zzh/proj/NewWork2.0/results/ytb',
